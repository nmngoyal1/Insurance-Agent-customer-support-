...
class CustomerMemoryStore:
    """LangMem hot-path memory adapter.

    This implementation uses explicit manage-memory writes so accepted claim
    resolutions are always persisted deterministically.
    """
